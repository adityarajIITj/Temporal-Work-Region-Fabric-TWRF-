...
| Default timing model shows no TWRF advantage over Baseline C in the documented matrix | Derived timing result | docs/RESULTS.md | "Under the declared default timing parameters..." | "Hardware cannot beat software incremental methods" |
| The 54-setting sensitivity grid characterizes a cost boundary | Derived timing experiment | Implemented generator and CI schema checks | "The experiment sweeps declared architectural parameters" | "The sensitivity study proves optimal hardware parameters" |
